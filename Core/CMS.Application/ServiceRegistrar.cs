...
using CMS.Application.CrossCuttingConcerns.Exceptions;
using CMS.Application.CrossCuttingConcerns.Logging;
using CMS.Application.CrossCuttingConcerns.Validation;
...
public static class ServiceRegistrar
{
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddMediatR(cfg =>
        {
            ...
            // Order: Exception (outermost) -> Logging -> FluentValidation (innermost)
